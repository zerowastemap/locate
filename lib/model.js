...
_mongoose.default.Promise = global.Promise; // See http://mongoosejs.com/docs/promises.html

/*
 * Validations
 */

var emailValidator = (0, _mongooseValidator.default)({
  validator: 'isEmail',
  passIfEmpty: true,
  message: 'Please provide a valid email'
});
var urlValidator = (0, _mongooseValidator.default)({
  validator: 'isURL',
  passIfEmpty: true,
...
var LocationSchema = new Schema({
  ...
  rating: {
    ...
    max: 5,
    default: 0,
    // 0 = unrated, 1 = très limité, 2 = moyen, 3 = pas mal, 4 = recommandé, 5 = géniale
    required: false
  },
  note: {
    type: String,
  ...
  price: {
    ...
    max: 5,
    default: 3,
    // 0 = free, 1 = democratique, 2 = normal, 3 = normal +, 4 = cher, 5 = trop cher
    required: true
  },
  map: {
    type: Boolean,
